...
public class CarManager implements CarService {
	...
	public DataResult<List<ListCarDto>> getAll() {
		...
		if (result.isEmpty()) {
			return new ErrorDataResult<List<ListCarDto>>("Liste Bos");
		}
	...
	public Result delete(DeleteCarRequest deleteCarRequest) throws BusinessException {
		...
		if (checkCarId(deleteCarRequest.getCarId())) {
			this.carDao.deleteById(car.getCarId());
			return new SuccessResult("Arac.silindi");
		}
		return new ErrorResult("Arac.silinmedi");
	...
	public Result update(UpdateCarRequest updateCarRequest) throws BusinessException {
		...
		if (checkCarId(updateCarRequest.getCarId())) {
			this.carDao.save(car);
	...
	@Override
	public boolean checkCarId(int carId) throws BusinessException {
		var result = this.carDao.getByCarId(carId);
		if (result != null) {
			return true;
		}
