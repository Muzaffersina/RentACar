...
public interface CarMaintenanceService {	
	...
	boolean checkCarMaintenanceExists(int carMaintenanceId) throws BusinessException;
	boolean checkCarMaintenceCarIdReturnDate(int carId) throws BusinessException;
	boolean checkCarMaintenceReturnDate(int maintenanceId) throws BusinessException;
