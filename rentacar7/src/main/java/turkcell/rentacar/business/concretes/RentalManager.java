...
public class RentalManager implements RentalService {
	...
	@Override
	public List<ListRentDto> getByCarCarId(int carId) {
	...
	public boolean checkCityUsed(int cityId) {
		/*
		var result = this.rentDao.getAllByCity_CityId(cityId);
		if(result == null) {
			return true;
		}
		*/
		return true ; 
		//throw new BusinessException("Silinemez. City kullanılmıştır.");
	}
	...
	public boolean checkCustomerUsed(int customerId) {
		...
		throw new BusinessException("Silinemez. CustomerId kullanılmıştır.");
	}	
